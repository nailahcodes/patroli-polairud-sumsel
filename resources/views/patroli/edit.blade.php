...
@section('content')
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        <div>
            <h2 class="page-title mb-1">Edit Patroli</h2>
            <p class="text-muted mb-0">
                Perbarui data patroli dan personel ABK yang bertugas.
            </p>
        </div>

        <div class="d-flex gap-2">
            <a href="{{ route('patroli.show', $patroli) }}" class="btn btn-outline-info rounded-3">
                Detail
            </a>
    ...
    @php
        $selectedPersonels = old(
            'personel_ids',
            $patroli->personels->pluck('id')->map(fn($id) => (string) $id)->toArray()
        );
    @endphp

    <div class="section-panel">
        <form action="{{ route('patroli.update', $patroli) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input
                        ...
                        name="nomor_sprin"
                        class="form-control"
                        value="{{ old('nomor_sprin', $patroli->nomor_sprin) }}"
                ...
                <div class="col-md-6">
                    ...
                    <select id:kapalSelect name="kapal_id" class="form-select" required>
                        ...
                        @foreach($kapals as $kapal)
                            <option
                                ...
                                {{ old('kapal_id', $patroli->kapal_id) == $kapal->id ? 'selected' : '' }}
                            >
                                {{ $kapal->kode_kapal }}
                                —
                                {{ $kapal->zona_patroli ?? '-' }}
                ...
                <div class="col-md-12">
                    ...
                    <input
                        ...
                        class="form-control"
                        value="{{ old('wilayah_patroli', $patroli->wilayah_patroli) }}"
                ...
                <div class="col-md-4">
                    ...
                    <input
                        ...
                        class="form-control"
                        value="{{ old('tanggal_persiapan', optional($patroli->tanggal_persiapan)->format('Y-m-d')) }}"
                        required
                    >
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input
                        ...
                        name="tanggal_mulai"
                        class="form-control"
                        value="{{ old('tanggal_mulai', optional($patroli->tanggal_mulai)->format('Y-m-d')) }}"
                        required
                    >
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input
                        ...
                        class="form-control"
                        value="{{ old('tanggal_selesai', optional($patroli->tanggal_selesai)->format('Y-m-d')) }}"
                        required
                    >
                </div>

                <div class="col-md-12">
                    <label class="form-label">Edit Personel ABK Kapal</label>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <label class="personel-checkbox">
                                        <input
                                            ...
                                            name="personel_ids[]"
                                            value="{{ $abk->id }}"
                                            {{ in_array((string) $abk->id, $selectedPersonels) ? 'checked' : '' }}
                                        >
                    ...
                    <small class="text-muted d-block mt-2">
                        Centang personel ABK yang ditugaskan dalam patroli ini.
                    </small>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    >{{ old('keterangan', $patroli->keterangan) }}</textarea>
                </div>
            </div>
